...
% MSRA1K PASCAL DUT-OMRON
% SRC = 'E:\Dataset\img\testE\img\';       %Path of input images
SRC = 'E:\dataset\dataset\img\ECSSD\';
BDCON = 'Data\BDCON';   %Path for saving bdCon feature image
RES = 'E:\dataset\result\RBD\';       %Path for saving saliency maps
RES_MR = 'E:\dataset\result\GS\';
...
%     SaveSaliencyMap(geoDist, pixelList, frameRecord, smapName, true);
    ...
    %     smapName=fullfile(RES_MR, strcat(noSuffixName, '_MR_stage1.png'));
