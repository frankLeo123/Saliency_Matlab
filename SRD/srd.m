function [ ] = srd( imgRoot_,saldir_,input_suffix )
%SRD 此处显示有关此函数的摘要
%   此处显示详细说明
addpath('./SRD/others/');
addpath('./SRD/');
...
% input_suffix = '.jpg';
% imgRoot='E:\Dataset\img\testE\img\';
% saldir='E:\Dataset\img\testE\img\test\';
imgRoot= imgRoot_;
saldir=saldir_;% the output path of the saliency map
supdir='.\SRD\superpixels\';% the superpixel label file path
mkdir(supdir);
mkdir(saldir);
imnames=dir([imgRoot '*' input_suffix]);
...
%     imname=[imname(1:end-4) input_suffix];
